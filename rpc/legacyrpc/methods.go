...
type requestHandlerChainRequired func(interface{}, *wallet.Wallet, *btcclient.RPCClient) (interface{}, error)
...
func lazyApplyHandler(request *btcjson.Request, w *wallet.Wallet, chainClient btcclient.Interface) lazyHandler {
...
// exist.
func getInfo(icmd interface{}, w *wallet.Wallet, chainClient *btcclient.RPCClient) (interface{}, error) {
...
// passthrough.
func helpWithChainRPC(icmd interface{}, w *wallet.Wallet, chainClient *btcclient.RPCClient) (interface{}, error) {
...
func help(icmd interface{}, _ *wallet.Wallet, chainClient *btcclient.RPCClient) (interface{}, error) {
...
func listSinceBlock(icmd interface{}, w *wallet.Wallet, chainClient *btcclient.RPCClient) (interface{}, error) {
...
func sendFrom(icmd interface{}, w *wallet.Wallet, chainClient *btcclient.RPCClient) (interface{}, error) {
...
func signRawTransaction(icmd interface{}, w *wallet.Wallet, chainClient *btcclient.RPCClient) (interface{}, error) {
